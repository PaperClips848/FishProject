...
fileName_c = 'envData10-DayTimeSeries_18f.csv'
...
summary_df.to_csv("env_summary_metrics.csv", index=False)

# ---- 2. Combine both csvs into one
env_static = pd.read_csv("seth_environmentalGenusCountData_nov2024.csv")
env_metrics = pd.read_csv("env_summary_metrics.csv")
...
merged.to_csv("envAttrGenusCountSumMetrics_feb2026.csv", index=False)